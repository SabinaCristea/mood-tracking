...
// export const seedMoodQuotes = mutation(async (ctx) => {
//   const existing = await ctx.db.query("moodQuotes").collect();
...
//   for (const [orderStr, quotes] of Object.entries(moodQuotes)) {
...
//     if (!moodOption) continue;

//     for (const text of quotes) {
//       await ctx.db.insert("moodQuotes", {
//         moodOptionId: moodOption._id,
//         text,
//       });
//     }
//   }
